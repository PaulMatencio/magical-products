...
import { c as mt, a2 as Tr, a3 as Yt, a4 as ot, a5 as ls, R as D, a as H, r as S, b as ds, l as us, j as a, a6 as qe, f as ps, m as $, h as hs, U as fs, J as ms, Q as Pr, A as Ut, a7 as xs, L as Ne, k as gs, v as he, y as ze, E as Qt, i as ys, X as xt, G as Lt } from "./index-CzbLWvhF.js";
import { r as bs, D as Ir, f as Ve, S as pt, c as ws, t as vs, n as ks, a as Ss, b as Es, d as Ns, e as js, g as Cs, h as $t, i as _s, j as As, P as Fr, k as Rs, l as Os, m as Ts, o as Ps, p as Is, q as hn, Q as fn, B as Mt, T as Fs } from "./index-cd3p4fKW.js";
import { A as Ds } from "./arrow-left-Ba5DNmIN.js";
import { H as Bs } from "./hash-BeVyaVHN.js";
import { C as He } from "./circle-check-DVkaDoXO.js";
import { C as We } from "./credit-card-CGNFfGpa.js";
import { S as Us } from "./shopping-cart-BsraYMZd.js";
/**
...
*/
const Ls = [["circle", { cx: "8", cy: "8", r: "6", key: "3yglwk" }], ["path", { d: "M18.09 10.37A6 6 0 1 1 10.34 18", key: "t5s6rm" }], ["path", { d: "M7 6h1v4", key: "1obek4" }], ["path", { d: "m16.71 13.88.7.71-2.82 2.82", key: "1rbuyh" }]], Dr = mt("coins", Ls);
/**
* @license lucide-react v0.546.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
const $s = [["path", { d: "M10 18v-7", key: "wt116b" }], ["path", { d: "M11.12 2.198a2 2 0 0 1 1.76.006l7.866 3.847c.476.233.31.949-.22.949H3.474c-.53 0-.695-.716-.22-.949z", key: "1m329m" }], ["path", { d: "M14 18v-7", key: "vav6t3" }], ["path", { d: "M18 18v-7", key: "aexdmj" }], ["path", { d: "M3 22h18", key: "8prr45" }], ["path", { d: "M6 18v-7", key: "1ivflk" }]], ht = mt("landmark", $s);
/**
* @license lucide-react v0.546.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
const Ms = [["rect", { width: "14", height: "20", x: "5", y: "2", rx: "2", ry: "2", key: "1yt0o3" }], ["path", { d: "M12 18h.01", key: "mhygvu" }]], Je = mt("smartphone", Ms);
/**
* @license lucide-react v0.546.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
const qs = [["path", { d: "M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1", key: "18etb6" }], ["path", { d: "M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4", key: "xoc0q4" }]], Br = mt("wallet", qs);
function mn(t2, e) {
  return function() {
    return t2.apply(e, arguments);
  };
}
const { toString: Hs } = Object.prototype, { getPrototypeOf: gt } = Object, { iterator: yt, toStringTag: xn } = Symbol, bt = /* @__PURE__ */ ((t2) => (e) => {
  const r = Hs.call(e);
  return t2[r] || (t2[r] = r.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), fe = (t2) => (t2 = t2.toLowerCase(), (e) => bt(e) === t2), wt = (t2) => (e) => typeof e === t2, { isArray: je } = Array, Re = wt("undefined");
function Te(t2) {
...
const Vs = wt("string"), ae = wt("function"), yn = wt("number"), Ke = (t2) => t2 !== null && typeof t2 == "object", Ws = (t2) => t2 === true || t2 === false, it = (t2) => {
  if (bt(t2) !== "object") return false;
  const e = gt(t2);
  return (e === null || e === Object.prototype || Object.getPrototypeOf(e) === null) && !(xn in t2) && !(yt in t2);
}, Js = (t2) => {
...
}, Ks = fe("Date"), Xs = fe("File"), Gs = (t2) => !!(t2 && typeof t2.uri < "u"), Ys = (t2) => t2 && typeof t2.getParts < "u", Qs = fe("Blob"), Zs = fe("FileList"), ea = (t2) => Ke(t2) && ae(t2.pipe);
function ta() {
  return typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof Yt < "u" ? Yt : {};
}
...
const Se = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : Yt, wn = (t2) => !Re(t2) && t2 !== Se;
function Zt(...t2) {
  const { caseless: e, skipUndefined: r } = wn(this) && this || {}, n = {}, s = (o, i) => {
    if (i === "__proto__" || i === "constructor" || i === "prototype") return;
    const c = e && typeof i == "string" && bn(n, i) || i, d = er(n, c) ? n[c] : void 0;
    it(d) && it(o) ? n[c] = Zt(d, o) : it(o) ? n[c] = Zt({}, o) : je(o) ? n[c] = o.slice() : (!r || !Re(o)) && (n[c] = o);
  };
...
const la = (t2, e, r, { allOwnKeys: n } = {}) => (Xe(e, (s, o) => {
  r && ae(s) ? Object.defineProperty(t2, o, { __proto__: null, value: mn(s, r), writable: true, enumerable: true, configurable: true }) : Object.defineProperty(t2, o, { __proto__: null, value: s, writable: true, enumerable: true, configurable: true });
  ...
  for (; e-- > 0; ) r[e] = t2[e];
  return r;
}, ma = /* @__PURE__ */ ((t2) => (e) => t2 && e instanceof t2)(typeof Uint8Array < "u" && gt(Uint8Array)), xa = (t2, e) => {
  const n = (t2 && t2[yt]).call(t2);
  let s;
  for (; (s = n.next()) && !s.done; ) {
    const o = s.value;
    e.call(t2, o[0], o[1]);
...
}), er = (({ hasOwnProperty: t2 }) => (e, r) => t2.call(e, r))(Object.prototype), { propertyIsEnumerable: wa } = Object.prototype, va = fe("RegExp"), vn = (t2, e) => {
...
function ja(t2) {
  return !!(t2 && ae(t2.append) && t2[xn] === "FormData" && t2[yt]);
}
const Ca = (t2) => {
  ...
  return r(t2);
}, _a = fe("AsyncFunction"), Aa = (t2) => t2 && (Ke(t2) || ae(t2)) && ae(t2.then) && ae(t2.catch), kn = ((t2, e) => t2 ? setImmediate : e ? ((r, n) => (Se.addEventListener("message", ({ source: s, data: o }) => {
  s === Se && o === r && n.length && n.shift()();
}, false), (s) => {
  n.push(s), Se.postMessage(r, "*");
}))(`axios@${Math.random()}`, []) : (r) => setTimeout(r))(typeof setImmediate == "function", ae(Se.postMessage)), Ra = typeof queueMicrotask < "u" ? queueMicrotask.bind(Se) : typeof Tr < "u" && Tr.nextTick || kn, Oa = (t2) => t2 != null && ae(t2[yt]), l = { isArray: je, isArrayBuffer: gn, isBuffer: Te, isFormData: ra, isArrayBufferView: zs, isString: Vs, isNumber: yn, isBoolean: Ws, isObject: Ke, isPlainObject: it, isEmptyObject: Js, isReadableStream: sa, isRequest: aa, isResponse: oa, isHeaders: ia, isUndefined: Re, isDate: Ks, isFile: Xs, isReactNativeBlob: Gs, isReactNative: Ys, isBlob: Qs, isRegExp: va, isFunction: ae, isStream: ea, isURLSearchParams: na, isTypedArray: ma, isFileList: Zs, forEach: Xe, merge: Zt, extend: la, trim: ca, stripBOM: da, inherits: ua, toFlatObject: pa, kindOf: bt, kindOfTest: fe, endsWith: ha, toArray: fa, forEachEntry: xa, matchAll: ga, isHTMLForm: ya, hasOwnProperty: er, hasOwnProp: er, reduceDescriptors: vn, freezeMethods: ka, toObjectSet: Sa, toCamelCase: ba, noop: Ea, toFiniteNumber: Na, findKey: bn, global: Se, isContextDefined: wn, isSpecCompliantForm: ja, toJSONObject: Ca, isAsyncFn: _a, isThenable: Aa, setImmediate: kn, asap: Ra, isIterable: Oa }, Ta = l.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]), Pa = (t2) => {
  const e = {};
  let r, n, s;
  return t2 && t2.split(`
`).forEach(function(i) {
...
const Fa = new RegExp("[\\u0000-\\u0008\\u000a-\\u001f\\u007f]+", "g"), Da = new RegExp("[^\\u0009\\u0020-\\u007e\\u0080-\\u00ff]+", "g");
function or(t2, e) {
  return l.isArray(t2) ? t2.map((r) => or(r, e)) : Ia(String(t2).replace(e, ""));
}
const Ba = (t2) => or(t2, Fa), Ua = (t2) => or(t2, Da);
function Sn(t2) {
...
function ct(t2) {
  return t2 === false || t2 == null ? t2 : l.isArray(t2) ? t2.map(ct) : Ba(String(t2));
}
function La(t2) {
...
let te = class {
  ...
  set(e, r, n) {
    ...
    function o(c, d, u) {
      ...
      (!m || s[m] === void 0 || u === true || u === void 0 && s[m] !== false) && (s[m || d] = ct(c));
    }
  ...
  delete(e, r) {
    ...
    function o(i) {
      if (i = Le(i), i) {
        ...
        c && (!r || qt(n, n[c], c, r)) && (delete n[c], s = true);
      }
    }
  ...
  clear(e) {
    ...
    for (; n--; ) {
      const o = r[n];
      (!e || qt(this, this[o], o, e, true)) && (delete this[o], s = true);
    }
    return s;
  }
  normalize(e) {
    ...
    return l.forEach(this, (s, o) => {
      ...
      c !== o && delete r[o], r[c] = ct(s), n[c] = true;
    }), this;
  }
  concat(...e) {
...
l.reduceDescriptors(te.prototype, ({ value: t2 }, e) => {
...
function Va(t2, e) {
  const r = new Set(e.map((o) => String(o).toLowerCase())), n = [], s = (o) => {
    ...
    o instanceof te && (o = o.toJSON()), n.push(o);
    let i;
...
function Ja(t2) {
  return l.isArray(t2) && !t2.some(tr);
}
...
function vt(t2, e, r) {
  ...
  function p(g) {
    ...
    return l.isArrayBuffer(g) || l.isTypedArray(g) ? u && typeof Blob == "function" ? new Blob([g]) : ot.from(g) : g;
  }
  function m(g, h, b) {
    let C = g;
    if (l.isReactNative(e) && l.isReactNativeBlob(g)) return e.append(Ht(b, h, o), p(g)), false;
    if (g && !b && typeof g == "object") {
      if (l.endsWith(h, "{}")) h = n ? h : h.slice(0, -2), g = JSON.stringify(g);
        ...
        !(l.isUndefined(N) || N === null) && e.append(i === true ? Ht([h], O, o) : i === null ? h : h + "[]", p(N));
      }), false;
    }
    return tr(g) ? true : (e.append(Ht(b, h, o), p(g)), false);
  }
  const x = [], y = Object.assign(Ka, { defaultVisitor: m, convertValue: p, isVisitable: tr });
  function k(g, h, b = 0) {
    if (!l.isUndefined(g)) {
...
function ir(t2, e) {
  this._pairs = [], t2 && vt(t2, this, e);
}
const jn = ir.prototype;
...
function Cn(t2, e, r) {
  ...
  let i;
  if (o ? i = o(e, s) : i = l.isURLSearchParams(e) ? e.toString() : new ir(e, s).toString(n), i) {
    const c = t2.indexOf("#");
...
const cr = { silentJSONParsing: true, forcedJSONParsing: true, clarifyTimeoutError: false, legacyInterceptorReqResOrdering: true, advertiseZstdAcceptEncoding: false }, Ga = typeof URLSearchParams < "u" ? URLSearchParams : ir, Ya = typeof FormData < "u" ? FormData : null, Qa = typeof Blob < "u" ? Blob : null, Za = { isBrowser: true, classes: { URLSearchParams: Ga, FormData: Ya, Blob: Qa }, protocols: ["http", "https", "file", "blob", "url", "data"] }, lr = typeof window < "u" && typeof document < "u", rr = typeof navigator == "object" && navigator || void 0, eo = lr && (!rr || ["ReactNative", "NativeScript", "NS"].indexOf(rr.product) < 0), to = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function", ro = lr && window.location.href || "http://localhost", no = Object.freeze(Object.defineProperty({ __proto__: null, hasBrowserEnv: lr, hasStandardBrowserEnv: eo, hasStandardBrowserWebWorkerEnv: to, navigator: rr, origin: ro }, Symbol.toStringTag, { value: "Module" })), K = { ...no, ...Za };
function so(t2, e) {
  return vt(t2, new K.classes.URLSearchParams(), { visitor: function(r, n, s, o) {
...
const Ge = { transitional: cr, adapter: ["xhr", "http", "fetch"], transformRequest: [function(e, r) {
  ...
  if (o) {
    ...
    if ((c = l.isFileList(e)) || n.indexOf("multipart/form-data") > -1) {
      ...
      return vt(c ? { "files[]": e } : e, p && new p(), d);
    }
  }
...
function zt(t2, e) {
  const r = this || Ge, n = e || r, s = te.from(n.headers);
  let o = n.data;
...
const Vr = (t2) => t2 instanceof te ? { ...t2 } : t2;
function Ce(t2, e) {
  e = e || {};
  const r = /* @__PURE__ */ Object.create(null);
...
const bo = typeof XMLHttpRequest < "u", wo = bo && function(t2) {
  return new Promise(function(r, n) {
    ...
    "onloadend" in h ? h.onloadend = b : h.onreadystatechange = function() {
      ...
      const O = N && N.message ? N.message : "Network Error", F = new v(O, v.ERR_NETWORK, t2, h);
    ...
    }), l.isUndefined(s.withCredentials) || (h.withCredentials = !!s.withCredentials), c && c !== "json" && (h.responseType = s.responseType), u && ([x, k] = ft(u, true), h.addEventListener("progress", x)), d && h.upload && ([m, y] = ft(d), h.upload.addEventListener("progress", m), h.upload.addEventListener("loadend", y)), (s.cancelToken || s.signal) && (p = (_) => {
...
function No(t2) {
  ...
  if (typeof ot < "u" && typeof ot.byteLength == "function") return ot.byteLength(n, "utf8");
  let o = 0;
...
const dr = "1.17.0", Jr = 64 * 1024, { isFunction: rt } = l, jo = (t2) => encodeURIComponent(t2).replace(/%([0-9A-F]{2})/gi, (e, r) => String.fromCharCode(parseInt(r, 16))), Kr = (t2) => {
  ...
  const { fetch: s, Request: o, Response: i } = t2, c = s ? rt(s) : typeof fetch == "function", d = rt(o), u = rt(i);
  if (!c) return false;
  const p = c && rt(r), m = c && (typeof n == "function" ? /* @__PURE__ */ ((b) => (C) => b.encode(C))(new n()) : async (b) => new Uint8Array(await new o(b).arrayBuffer())), x = d && p && Xr(() => {
    let b = false;
  ...
  return async (b) => {
    let { url: C, method: _, data: N, signal: O, cancelToken: F, timeout: ce, onDownloadProgress: xe, onUploadProgress: Pe, responseType: le, headers: ie, withCredentials: be = "same-origin", fetchOptions: Ie, maxContentLength: E, maxBodyLength: W } = Tn(b);
    const X = l.isNumber(E) && E > -1, de = l.isNumber(W) && W > -1, G = (T) => l.hasOwnProp(b, T) ? b[T] : void 0;
    let ge = s || fetch;
    le = le ? (le + "").toLowerCase() : "text";
    let P = vo([O, F && F.toAbortSignal()], ce), J = null;
    ...
    try {
      ...
      const ee = G("auth");
      if (ee) {
        const A = ee.username || "", ne = ee.password || "";
        T = { username: A, password: ne };
      }
      if (Co(C)) {
        const A = new URL(C, K.origin);
        if (!T && (A.username || A.password)) {
          const ne = Kr(A.username), pe = Kr(A.password);
          T = { username: ne, password: pe };
        }
        (A.username || A.password) && (A.username = "", A.password = "", C = A.href);
      }
      if (T && (ie.delete("authorization"), ie.set("Authorization", "Basic " + btoa(jo((T.username || "") + ":" + (T.password || ""))))), X && typeof C == "string" && C.startsWith("data:") && No(C) > E) throw new v("maxContentLength size of " + E + " exceeded", v.ERR_BAD_RESPONSE, b, J);
      if (de && _ !== "get" && _ !== "head") {
        const A = await h(ie, N);
        if (typeof A == "number" && isFinite(A) && A > W) throw new v("Request body larger than maxBodyLength limit", v.ERR_BAD_REQUEST, b, J);
      }
      if (Pe && x && _ !== "get" && _ !== "head" && (ue = await h(ie, N)) !== 0) {
        let A = new o(C, { method: "POST", body: N, duplex: "half" }), ne;
        if (l.isFormData(N) && (ne = A.headers.get("content-type")) && ie.setContentType(ne), A.body) {
          const [pe, ye] = Hr(ue, ft(zr(Pe)));
          N = Wr(A.body, Jr, pe, ye);
        }
      }
      l.isString(be) || (be = be ? "include" : "omit");
      const B = d && "credentials" in o.prototype;
      if (l.isFormData(N)) {
        const A = ie.getContentType();
        A && /^multipart\/form-data/i.test(A) && !/boundary=/i.test(A) && ie.delete("content-type");
      }
      ie.set("User-Agent", "axios/" + dr, false);
      const oe = { ...Ie, signal: P, method: _.toUpperCase(), headers: Sn(ie.normalize()), body: N, duplex: "half", credentials: B ? be : void 0 };
      J = d && new o(C, oe);
      let re = await (d ? ge(J, Ie) : ge(C, oe));
      if (X) {
        const A = l.toFiniteNumber(re.headers.get("content-length"));
        if (A != null && A > E) throw new v("maxContentLength size of " + E + " exceeded", v.ERR_BAD_RESPONSE, b, J);
      }
      const me = y && (le === "stream" || le === "response");
      if (y && re.body && (xe || X || me && M)) {
        const A = {};
        ["status", "statusText", "headers"].forEach((ve) => {
          A[ve] = re[ve];
        });
        const ne = l.toFiniteNumber(re.headers.get("content-length")), [pe, ye] = xe && Hr(ne, ft(zr(xe), true)) || [];
        let _e = 0;
        const we = (ve) => {
          if (X && (_e = ve, _e > E)) throw new v("maxContentLength size of " + E + " exceeded", v.ERR_BAD_RESPONSE, b, J);
          pe && pe(ve);
        };
        re = new i(Wr(re.body, Jr, we, () => {
          ye && ye(), M && M();
        }), A);
      }
      le = le || "text";
      let Y = await k[l.findKey(k, le) || "text"](re, b);
      if (X && !y && !me) {
        let A;
      ...
      return !me && M && M(), await new Promise((A, ne) => {
        Rn(A, ne, { data: Y, headers: te.from(re.headers), status: re.status, statusText: re.statusText, config: b, request: J });
      });
    } catch (T) {
      if (M && M(), P && P.aborted && P.reason instanceof v) {
        const ee = P.reason;
        throw ee.config = b, J && (ee.request = J), T !== ee && (ee.cause = T), ee;
      }
...
Pn();
const ur = { http: Wa, xhr: wo, fetch: { get: Pn } };
l.forEach(ur, (t2, e) => {
  if (t2) {
    try {
...
function Oo(t2, e) {
  ...
  for (let i = 0; i < r; i++) {
    n = t2[i];
    let c;
    if (s = n, !Ro(n) && (s = ur[(c = String(n)).toLowerCase()], s === void 0)) throw new v(`Unknown adapter '${c}'`);
...
const In = { getAdapter: Oo, adapters: ur };
function Vt(t2) {
  if (t2.cancelToken && t2.cancelToken.throwIfRequested(), t2.signal && t2.signal.aborted) throw new Ye(null, t2);
}
function Yr(t2) {
  return Vt(t2), t2.headers = te.from(t2.headers), t2.data = zt.call(t2, t2.transformRequest), ["post", "put", "patch"].indexOf(t2.method) !== -1 && t2.headers.setContentType("application/x-www-form-urlencoded", false), In.getAdapter(t2.adapter || Ge.adapter, t2)(t2).then(function(n) {
    Vt(t2), t2.response = n;
    try {
      n.data = zt.call(t2, t2.transformResponse, n);
    } finally {
      delete t2.response;
    }
    return n.headers = te.from(n.headers), n;
  }, function(n) {
    if (!An(n) && (Vt(t2), n && n.response)) {
      t2.response = n.response;
      try {
        n.response.data = zt.call(t2, t2.transformResponse, n.response);
      } finally {
        delete t2.response;
      }
...
const Qr = {};
kt.transitional = function(e, r, n) {
  function s(o, i) {
    return "[Axios v" + dr + "] Transitional option '" + o + "'" + i + (n ? ". " + n : "");
  }
  return (o, i, c) => {
...
const lt = { assertOptions: To, validators: kt }, se = lt.validators;
let Ee = class {
  constructor(e) {
...
` + o);
  ...
  _request(e, r) {
    ...
    n !== void 0 && lt.assertOptions(n, { silentJSONParsing: se.transitional(se.boolean), forcedJSONParsing: se.transitional(se.boolean), clarifyTimeoutError: se.transitional(se.boolean), legacyInterceptorReqResOrdering: se.transitional(se.boolean), advertiseZstdAcceptEncoding: se.transitional(se.boolean) }, false), s != null && (l.isFunction(s) ? r.paramsSerializer = { serialize: s } : lt.assertOptions(s, { encode: se.function, serialize: se.function }, true)), r.allowAbsoluteUrls !== void 0 || (this.defaults.allowAbsoluteUrls !== void 0 ? r.allowAbsoluteUrls = this.defaults.allowAbsoluteUrls : r.allowAbsoluteUrls = true), lt.assertOptions(r, { baseUrl: se.spelling("baseURL"), withXsrfToken: se.spelling("withXSRFToken") }, true), r.method = (r.method || this.defaults.method || "get").toLowerCase();
    let i = o && l.merge(o.common, o[r.method]);
    o && l.forEach(["delete", "get", "head", "post", "put", "patch", "query", "common"], (k) => {
      delete o[k];
    }), r.headers = te.concat(i, o);
    const c = [];
    let d = true;
...
var R = (t2) => U.isAxiosError(t2) ? t2.response ? JSON.stringify({ data: t2.response.data, headers: t2.response.headers, status: t2.response.status }) : t2.request && !(t2.request instanceof XMLHttpRequest) ? JSON.stringify(t2.request) : JSON.stringify({ code: t2.code, message: t2.message }) : JSON.stringify(t2), Zr = (t2) => {
  const e = t2.slice(0, Fr), r = t2.includes(".") ? Ve(t2.split(".")[1] || "") : t2.slice(Fr);
...
var nt = class j {
  ...
  async fetchHandle(e) {
    try {
      const r = Ve(e.replace("$", "")), n = `${pt[1]}000de140${r}`;
  ...
  async fetchHandleAddress(e) {
    var _a2;
    const r = Ve(e.replace("$", "")), n = pt[1], o = (_a2 = (await this.fetchAssetAddresses(`${n}${r}`))[0]) == null ? void 0 : _a2.address;
  ...
  addSerializedTransaction(e) {
    const r = Es.fromCbor(Ns(e)), n = Date.now(), s = js(this.network ?? "mainnet", n), o = Cs(this.network ?? "mainnet", n), i = this.slotToEpochSlot(BigInt(s)), c = $t.randomBytes(32).toString("hex"), d = $t.randomBytes(32).toString("hex"), u = $t.randomBytes(32).toString("hex"), p = r.body().fee().toString(), m = r.body().outputs().reduce((N, O) => {
      const F = O.amount().coin();
      return N + F;
      ...
      const O = N.transactionId(), F = Number(N.index()), ce = Object.values(this.utxos).flat().find((xe) => xe.input.txHash === O && xe.input.outputIndex === F);
      if (!ce) throw new Error(`UTxO not found for transaction hash and output index: ${O} ${F}`);
      return ce;
    });
  ...
  constructor(...t2) {
    ...
    (e == null ? void 0 : e.enableCaching) && (this._enableCaching = true, this._offlineFetcher = e.offlineFetcher || new nt(this._network));
  }
  ...
  async fetchHandle(t2) {
    ...
    try {
      ...
      return await this.fetchAssetMetadata(`${pt[1]}000de140${e}`);
    } catch (e) {
      throw R(e);
    }
  }
  async fetchHandleAddress(t2) {
    if (this._network !== "mainnet") throw new Error("Does not support fetching addresses by handle on non-mainnet networks.");
    try {
      const e = Ve(t2.replace("$", "")), { data: r, status: n } = await this._axiosInstance.get(`assets/${pt[1]}${e}/addresses`);
  ...
  setCaching(t2, e) {
    this._enableCaching = t2, t2 ? this._offlineFetcher = e || new nt(this._network) : this._offlineFetcher = void 0;
  }
  getOfflineFetcher() {
  ...
  importCache(t2, e = true) {
    if (e && !this._enableCaching && this.setCaching(true), this._offlineFetcher) {
      const r = nt.fromJSON(t2);
      this._offlineFetcher = r;
    }
  }
  clearCache() {
    this._offlineFetcher && (this._offlineFetcher = new nt(this._network));
  }
};
function dt(t2) {
...
var Vo = function(e) {
...
}, $e = null, st = null, at = null, Ko = function(e) {
  return function(r) {
  ...
  return $e !== null ? $e : ($e = new Promise(function(r, n) {
    ...
    try {
      ...
      if (!(s && e)) {
        if (!s) s = rn(e);
        else if (s && at !== null && st !== null) {
          var o;
          s.removeEventListener("load", at), s.removeEventListener("error", st), (o = s.parentNode) === null || o === void 0 || o.removeChild(s), s = rn(e);
        }
      }
      at = Xo(r, n), st = Ko(n), s.addEventListener("load", at), s.addEventListener("error", st);
    } catch (i) {
      n(i);
      return;
    }
  ...
  var s = r[0];
  if (typeof s != "string") throw new Error("Expected publishable key to be of type string, got type ".concat(dt(s), " instead."));
...
function ei() {
  ...
  return r.resetWarningCache = e, Kt = function() {
...
var an;
function ti() {
  return an || (an = 1, Wt.exports = ei()()), Wt.exports;
}
var ri = ti();
const L = ls(ri);
function on(t2, e) {
...
St.displayName = "ElementsContext";
var Vn = function(e, r) {
  ...
  var r = e.stripe, n = e.options, s = e.children, o = D.useMemo(function() {
    return pi(r);
  }, [r]), i = D.useState(function() {
  ...
  }, [n, m, d.elements]), D.useEffect(function() {
    hi(d.stripe);
  }, [d.stripe]), D.createElement(St.Provider, { value: d }, s);
};
Wn.propTypes = { stripe: L.any, options: L.object };
var fi = function(e) {
  var r = D.useContext(St);
  return Vn(r, e);
}, mi = function() {
...
L.func.isRequired;
var Jn = D.createContext(null);
Jn.displayName = "CheckoutContext";
var ar = function(e) {
  var r = D.useContext(Jn), n = D.useContext(St);
  if (r) {
  ...
  var s = "".concat(gi(e), "Element"), o = function(u) {
    var p = u.id, m = u.className, x = u.options, y = x === void 0 ? {} : x, k = u.onBlur, g = u.onFocus, h = u.onReady, b = u.onChange, C = u.onEscape, _ = u.onClick, N = u.onLoadError, O = u.onLoaderStart, F = u.onNetworksChange, ce = u.onConfirm, xe = u.onCancel, Pe = u.onShippingAddressChange, le = u.onShippingRateChange, ie = u.onSavedPaymentMethodRemove, be = u.onSavedPaymentMethodUpdate, Ie = u.onAvailablePaymentMethodsChange, E = ar("mounts <".concat(s, ">")), W = "elements" in E ? E.elements : null, X = "checkoutState" in E ? E.checkoutState : null, de = (X == null ? void 0 : X.type) === "success" || (X == null ? void 0 : X.type) === "loading" ? X.sdk : null, G = D.useState(null), ge = qn(G, 2), P = ge[0], J = ge[1], M = D.useRef(null), ue = D.useRef(null);
    Z(P, "blur", k), Z(P, "focus", g), Z(P, "escape", C), Z(P, "click", _), Z(P, "loaderror", N), Z(P, "loaderstart", O), Z(P, "networkschange", F), Z(P, "confirm", ce), Z(P, "cancel", xe), Z(P, "shippingaddresschange", Pe), Z(P, "shippingratechange", le), Z(P, "savedpaymentmethodremove", ie), Z(P, "savedpaymentmethodupdate", be), Z(P, "availablepaymentmethodschange", Ie), Z(P, "change", b);
    var T;
    h && (e === "expressCheckout" ? T = h : T = function() {
      h(P);
    }), Z(P, "ready", T), D.useLayoutEffect(function() {
      if (M.current === null && ue.current !== null && (W || de)) {
        var B = null;
        if (de) {
          var oe = de, re = de;
          switch (e) {
            case "paymentForm":
              ...
              break;
            case "payment":
              B = oe.createPaymentElement(y);
              break;
            case "address":
              if ("mode" in y) {
                var me = y.mode, Y = si(y, xi);
                if (me === "shipping") B = oe.createShippingAddressElement(Y);
                else if (me === "billing") B = oe.createBillingAddressElement(Y);
            ...
            case "expressCheckout":
              B = oe.createExpressCheckoutElement(y);
              break;
            case "currencySelector":
              B = de.createCurrencySelectorElement();
              break;
            case "taxId":
              B = oe.createTaxIdElement(y);
              break;
            case "contactDetails":
              B = oe.createContactDetailsElement();
              break;
            default:
        ...
        M.current = B, J(B), B && B.mount(ue.current);
      }
    }, [W, de, y]);
    var ee = sr(y);
    return D.useEffect(function() {
      if (M.current) {
        var B = Hn(y, ee, ["paymentRequest"]);
        B && "update" in M.current && M.current.update(B);
      }
    }, [y, ee]), D.useLayoutEffect(function() {
      return function() {
    ...
    }, []), D.createElement("div", { id: p, className: m, ref: ue });
  }, i = function(u) {
    ar("mounts <".concat(s, ">"));
    var p = u.id, m = u.className;
    return D.createElement("div", { id: p, className: m });
  }, c = r ? i : o;
...
}, V = typeof window > "u", yi = D.createContext(null);
yi.displayName = "EmbeddedCheckoutProviderContext";
var bi = function() {
  var e = ar("calls useStripe()"), r = e.stripe;
  return r;
};
z("auBankAccount", V);
z("card", V);
...
function rc({ onBack: t2, onInitiateStripe: e, onInitiateWero: r, onInitiateDigitalEuro: n, onInitiateCrypto: s, onComplete: o }) {
  ...
  const p = (f) => {
    var _a3;
    return f === "lace" ? i : ((_a3 = Gt[f]) == null ? void 0 : _a3.rate) || 1;
    ...
    const f = H.paymentMethods || ["stripe", "adyen", "digital_euro", "worldline", "paypal", "crypto"], w = Xt(), q = w.filter((Q) => f.includes(Q.id));
    return q.length > 0 ? q : w;
  }, []), [h, b] = S.useState(() => {
    var _a3;
    return ((_a3 = g[0]) == null ? void 0 : _a3.id) || "stripe";
  }), [C, _] = S.useState("phone"), [N, O] = S.useState(""), [F, ce] = S.useState(false), [xe, Pe] = S.useState(false), [le, ie] = S.useState("idle"), [be, Ie] = S.useState(""), [E, W] = S.useState({ name: "", street: "", city: "", zip: "", phone: "", invoiceEmail: x && !x.is_anonymous && x.email || "", country: "" }), [X, de] = S.useState(false);
  S.useEffect(() => {
    x && !x.is_anonymous && (x.email && W((w) => w.invoiceEmail ? w : { ...w, invoiceEmail: x.email }), (async () => {
      try {
        if (H.databaseProvider === "supabase") {
          const { data: w, error: q } = await he.from("user_roles").select("name, street, city, zip, phone, country").eq("user_id", x.id || x.$id).maybeSingle();
          w && !q && (W((Q) => ({ ...Q, name: w.name || Q.name, street: w.street || Q.street, city: w.city || Q.city, zip: w.zip || Q.zip, phone: w.phone || Q.phone, country: w.country || Q.country })), (w.name || w.street || w.city || w.zip || w.phone || w.country) && de(true));
        }
      } catch (w) {
  ...
  const [G, ge] = S.useState(null), [P, J] = S.useState(null), [M, ue] = S.useState(null), [T, ee] = S.useState(false), [B, oe] = S.useState(false), [re, me] = S.useState(false), [Y, A] = S.useState(null), [ne, pe] = S.useState(null), [ye, _e] = S.useState(false), [we, ve] = S.useState(false), [Qe, Kn] = S.useState(""), [Ze, Xn] = S.useState(""), Et = !!(E.name && E.street && E.city && E.zip && E.country && E.phone && (h !== "crypto" || G !== null) && (h !== "wero" || C === "qr" || C === "phone" && N.trim().length > 6) && (!we || Qe && Ze.length >= 6)), Gn = async (f) => {
    if (f === "lace") {
      ee(true);
      try {
        if (window.cardano && window.cardano.lace) {
          const q = await (await Mt.enable("lace")).getChangeAddress();
          q ? (ge("lace"), J(q), ue(null)) : alert("Connected to Lace, but no change address found.");
    ...
    } else ge(f), J("0x" + Math.random().toString(16).slice(2, 10) + "..." + Math.random().toString(16).slice(2, 6)), ue(null);
  }, Yn = async () => {
    var _a3;
    if (G) {
      oe(true);
      try {
        if (G === "lace") {
          const q = ((_a3 = (await (await Mt.enable("lace")).getBalance()).find((I) => I.unit === "lovelace")) == null ? void 0 : _a3.quantity) || "0", Q = (Number(q) / 1e6).toLocaleString(void 0, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
          ue(`${Q} ADA`);
        } else setTimeout(() => {
          ue(`1.25 ${Gt[G].symbol}`), oe(false);
        }, 800);
      } catch (f) {
  ...
  }, [pr, Qn] = S.useState(null), [hr, Zn] = S.useState(null), [Fe, es] = S.useState(null), [Nt, fr] = S.useState(false), [mr, xr] = S.useState(null), [gr, yr] = S.useState(null), [De, br] = S.useState(null), [wr, jt] = S.useState(null), [vr, Ct] = S.useState(null), [kr, _t] = S.useState(null), [Be, At] = S.useState(null), [Rt, Sr] = S.useState(false), [Er, Ot] = S.useState(null), [Nr, Tt] = S.useState(null), [Ue, Pt] = S.useState(null), [It, jr] = S.useState(false), et = S.useRef(false);
  S.useEffect(() => () => {
    if (et.current) return;
    const f = Fe || De || Be || Ue;
    f && (async () => {
      try {
        await he.rpc("cancel_order_with_inventory", { p_order_id: f });
      } catch (q) {
...
${E.country}`.trim();
    ...
    if (X && x && !x.is_anonymous) try {
      H.databaseProvider === "supabase" && await he.from("user_roles").update({ name: E.name, street: E.street, city: E.city, zip: E.zip, phone: E.phone, country: E.country, is_guest: false }).eq("user_id", x.id || x.$id);
    } catch (I) {
    ...
    if (h === "stripe") {
      ...
      try {
        ...
        H.activeFiatGateway === "adyen" && (xr(I.clientSecret), yr(I.paymentId), br(I.orderId || null));
      } catch (I) {
      ...
      try {
        ...
        _t(I.paymentId), jt(I.qrCodeData), Ct(I.redirectUrl), At(I.orderId || null);
      } catch (I) {
      ...
      try {
        ...
        Ot(I.paymentId), Tt(I.redirectUrl), Pt(I.orderId || null);
      } catch (I) {
      ...
      me(true), pe(null), _e(false);
      try {
        const I = await Mt.enable("lace"), ns = H.cryptoReceiverAddresses.lace, Ft = p("lace"), Dt = (y * Ft).toFixed(6), ss = Math.round(Number(Dt) * 1e6).toString(), _r = new Fs({ initiator: I });
        _r.sendLovelace(ns, ss);
        const as = await _r.build(), os = await I.signTx(as), tt = await I.submitTx(os);
        A(tt), _e(true);
        const Ar = we ? { email: Qe, password: Ze } : void 0, Rr = ((_b2 = E.invoiceEmail) == null ? void 0 : _b2.trim()) || void 0, ke = await s(w, E.phone, { txHash: tt, customerAddress: P || "", walletName: "lace", adaAmount: Dt, rateUsed: Ft }, Ar, Rr);
        let Or = false;
        const is = (H.cryptoPaymentTimeoutMinutes || 3) * 60 * 1e3, cs = setTimeout(async () => {
          if (Or = true, _e(false), me(false), pe(`Crypto payment confirmation timed out after ${H.cryptoPaymentTimeoutMinutes || 3} minutes.`), ke.paymentId && H.databaseProvider === "supabase") try {
            await he.from("payments").update({ provider_status: "expired", completed_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", ke.paymentId), console.log("Crypto payment marked as expired in DB:", ke.paymentId);
          } catch (Bt) {
            console.error("Failed to update payment to expired:", Bt);
          }
          if (ke.orderId && H.databaseProvider === "supabase") try {
            await he.rpc("cancel_order_with_inventory", { p_order_id: ke.orderId }), console.log("Crypto order cancelled on timeout:", ke.orderId);
          } catch (Bt) {
            console.error("Failed to cancel crypto order on timeout:", Bt);
          }
        }, is);
        new $o("preprodjz45ulPXDFrUvQJC54yYEKRAhJS0ZvZm").onTxConfirmed(tt, () => {
          Or || (clearTimeout(cs), et.current = true, o(h, w, E.phone, Ar, Rr, void 0, void 0, { txHash: tt, customerAddress: P || "", walletName: "lace", adaAmount: Dt, rateUsed: Ft, paymentId: ke.paymentId }));
        });
      } catch (I) {
        console.error("Cardano payment transaction failed:", I), pe((I == null ? void 0 : I.message) || (I == null ? void 0 : I.info) || JSON.stringify(I));
      } finally {
        me(false);
      }
...
function Ni({ sessionData: t2, paymentId: e, totalAmount: r, shippingInfo: n, user: s, onClose: o }) {
  ...
  return a.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 sm:p-6 overflow-y-auto", children: a.jsxs($.div, { initial: { opacity: 0, scale: 0.95, y: 20 }, animate: { opacity: 1, scale: 1, y: 0 }, exit: { opacity: 0, scale: 0.95, y: 20 }, className: "w-full max-w-md bg-white dark:bg-slate-900 border border-gray-100 dark:border-slate-800 rounded-3xl shadow-2xl p-6 sm:p-8 space-y-6", children: [a.jsxs("div", { className: "flex items-center justify-between", children: [a.jsxs("div", { className: "flex items-center gap-2.5", children: [a.jsx("div", { className: "p-2 bg-violet-50 dark:bg-violet-900/30 text-violet-600 dark:text-violet-400 rounded-xl animate-pulse", children: a.jsx(Lt, { className: "w-5 h-5" }) }), a.jsxs("div", { children: [a.jsxs("h3", { className: "text-base font-extrabold text-gray-900 dark:text-white flex items-center gap-2", children: ["Adyen Checkout ", a.jsx("span", { className: "text-[10px] px-1.5 py-0.5 bg-green-100 dark:bg-green-950 text-green-700 dark:text-green-300 rounded font-black tracking-wider uppercase", children: "Sandbox" })] }), a.jsx("p", { className: "text-xs text-gray-400 dark:text-gray-500", children: "Fast and secure global payments" })] })] }), a.jsx("button", { onClick: o, className: "p-1.5 hover:bg-gray-100 dark:hover:bg-slate-800 text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:hover:text-white rounded-xl transition-colors", children: a.jsx(xt, { className: "w-5 h-5" }) })] }), a.jsxs("div", { className: "flex gap-2 p-1 bg-gray-50 dark:bg-slate-800/40 rounded-xl border border-gray-100 dark:border-slate-800", children: [a.jsx("button", { type: "button", onClick: () => c("card"), className: `flex-1 py-2 px-3 text-xs font-bold rounded-lg transition-all ${i === "card" ? "bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm font-black" : "text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"}`, children: "Credit Card" }), a.jsx("button", { type: "button", onClick: () => c("sofort"), className: `flex-1 py-2 px-3 text-xs font-bold rounded-lg transition-all ${i === "sofort" ? "bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm font-black" : "text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"}`, children: "Sofort" }), a.jsx("button", { type: "button", onClick: () => c("ideal"), className: `flex-1 py-2 px-3 text-xs font-bold rounded-lg transition-all ${i === "ideal" ? "bg-white dark:bg-slate-800 text-indigo-600 dark:text-indigo-400 shadow-sm font-black" : "text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"}`, children: "iDEAL" })] }), a.jsxs("form", { onSubmit: N, className: "space-y-4", children: [i === "card" && a.jsxs("div", { className: "space-y-3.5", children: [a.jsxs("div", { children: [a.jsx("label", { className: "block text-[10px] font-black uppercase tracking-wider text-gray-400 dark:text-slate-500 mb-1", children: "Card Number" }), a.jsxs("div", { className: "relative", children: [a.jsx("input", { type: "text", placeholder: "4111 1111 1111 1111", maxLength: 19, value: d, onChange: (O) => {
    const F = O.target.value.replace(/\D/g, "").replace(/(\d{4})/g, "$1 ").trim();
    u(F);
...
function ji({ paymentId: t2, redirectUrl: e, totalAmount: r, onClose: n, onSuccess: s }) {
  const [o, i] = S.useState(false), [c, d] = S.useState(null), u = async (p) => {
    i(true), d(null);
    try {
      const { data: m, error: x } = await he.functions.invoke("digital-euro-checkout", { body: { action: "confirm", payment_id: t2, status: p } });
...
function Ci({ paymentId: t2, qrCodeData: e, redirectUrl: r, totalAmount: n, weroPhone: s, weroMode: o, onClose: i, onSuccess: c }) {
  const [d, u] = S.useState(false), [p, m] = S.useState(null), x = async (k) => {
    u(true), m(null);
    try {
      const { data: g, error: h } = await he.functions.invoke("wero-checkout", { body: { action: "confirm", payment_id: t2, status: k } });
