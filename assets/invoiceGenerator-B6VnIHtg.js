          ...
          <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            <tr>
              ...
              <td style="vertical-align: middle;">
                ...
                ${u?`<div style="margin-top: 5px;"><span style="display: inline-block; font-size: 10px; background-color: #fee2e2; color: #b91c1c; padding: 3px 7px; border-radius: 999px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.4px; font-family: ${e};">-${n.discount_percentage}% off</span></div>`:""}
              </td>
            </tr>
          </table>
        </td>
