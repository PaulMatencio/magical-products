import{t as h,a as b}from"./index-BbeXneOm.js";class m{constructor(o=0,i="Network Error"){this.status=o,this.text=i}}const E=()=>{if(!(typeof localStorage>"u"))return{get:t=>Promise.resolve(localStorage.getItem(t)),set:(t,o)=>Promise.resolve(localStorage.setItem(t,o)),remove:t=>Promise.resolve(localStorage.removeItem(t))}},l={origin:"https://api.emailjs.com",blockHeadless:!1,storageProvider:E()},y=t=>t?typeof t=="string"?{publicKey:t}:t.toString()==="[object Object]"?t:{}:{},U=(t,o="https://api.emailjs.com")=>{if(!t)return;const i=y(t);l.publicKey=i.publicKey,l.blockHeadless=i.blockHeadless,l.storageProvider=i.storageProvider,l.blockList=i.blockList,l.limitRate=i.limitRate,l.origin=i.origin||o},z=async(t,o,i={})=>{const a=await fetch(l.origin+t,{method:"POST",headers:i,body:o}),e=await a.text(),r=new m(a.status,e);if(a.ok)return r;throw r},_=(t,o,i)=>{if(!t||typeof t!="string")throw"The public key is required. Visit https://dashboard.emailjs.com/admin/account";if(!o||typeof o!="string")throw"The service ID is required. Visit https://dashboard.emailjs.com/admin";if(!i||typeof i!="string")throw"The template ID is required. Visit https://dashboard.emailjs.com/admin/templates"},B=t=>{if(t&&t.toString()!=="[object Object]")throw"The template params have to be the object. Visit https://www.emailjs.com/docs/sdk/send/"},T=t=>t.webdriver||!t.languages||t.languages.length===0,P=()=>new m(451,"Unavailable For Headless Browser"),K=(t,o)=>{if(!Array.isArray(t))throw"The BlockList list has to be an array";if(typeof o!="string")throw"The BlockList watchVariable has to be a string"},O=t=>{var o;return!((o=t.list)!=null&&o.length)||!t.watchVariable},q=(t,o)=>t instanceof FormData?t.get(o):t[o],L=(t,o)=>{if(O(t))return!1;K(t.list,t.watchVariable);const i=q(o,t.watchVariable);return typeof i!="string"?!1:t.list.includes(i)},j=()=>new m(403,"Forbidden"),M=(t,o)=>{if(typeof t!="number"||t<0)throw"The LimitRate throttle has to be a positive number";if(o&&typeof o!="string")throw"The LimitRate ID has to be a non-empty string"},A=async(t,o,i)=>{const a=Number(await i.get(t)||0);return o-Date.now()+a},S=async(t,o,i)=>{if(!o.throttle||!i)return!1;M(o.throttle,o.id);const a=o.id||t;return await A(a,o.throttle,i)>0?!0:(await i.set(a,Date.now().toString()),!1)},R=()=>new m(429,"Too Many Requests"),J=async(t,o,i,a)=>{const e=y(a),r=e.publicKey||l.publicKey,s=e.blockHeadless||l.blockHeadless,f=e.storageProvider||l.storageProvider,p={...l.blockList,...e.blockList},c={...l.limitRate,...e.limitRate};return s&&T(navigator)?Promise.reject(P()):(_(r,t,o),B(i),i&&L(p,i)?Promise.reject(j()):await S(location.pathname,c,f)?Promise.reject(R()):z("/api/v1.0/email/send",JSON.stringify({lib_version:"4.4.1",user_id:r,service_id:t,template_id:o,template_params:i}),{"Content-type":"application/json"}))},Q=t=>{if(!t||t.nodeName!=="FORM")throw"The 3rd parameter is expected to be the HTML form element or the style selector of the form"},W=t=>typeof t=="string"?document.querySelector(t):t,Y=async(t,o,i,a)=>{const e=y(a),r=e.publicKey||l.publicKey,s=e.blockHeadless||l.blockHeadless,f=l.storageProvider||e.storageProvider,p={...l.blockList,...e.blockList},c={...l.limitRate,...e.limitRate};if(s&&T(navigator))return Promise.reject(P());const g=W(i);_(r,t,o),Q(g);const d=new FormData(g);return L(p,d)?Promise.reject(j()):await S(location.pathname,c,f)?Promise.reject(R()):(d.append("lib_version","4.4.1"),d.append("service_id",t),d.append("template_id",o),d.append("user_id",r),z("/api/v1.0/email/send-form",d))},G={init:U,send:J,sendForm:Y,EmailJSResponseStatus:m};function u(t){return t.id.slice(0,8).toLowerCase()}function I(t){var v,w;const o=new Date(t.created_at).toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),i=new Date().toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"}),a=b.currency_symbol,e="'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif",r=n=>String(n??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),s=n=>`${a}${n.toFixed(2)}`,f=u(t),p=((w=(v=t.user_email)==null?void 0:v.split("@")[0])==null?void 0:w.replace(/[._-]+/g," "))||"Valued Customer",c=r(p),g=r(t.shipping_address||"Not provided").replace(/\n/g,"<br />"),d={pending:"background-color: #fff7ed; color: #c2410c; border-color: #fed7aa;",accepted:"background-color: #eff6ff; color: #1d4ed8; border-color: #bfdbfe;",ready:"background-color: #eef2ff; color: #4338ca; border-color: #c7d2fe;",shipped:"background-color: #f5f3ff; color: #6d28d9; border-color: #ddd6fe;",delivered:"background-color: #ecfdf5; color: #047857; border-color: #a7f3d0;"},F=d[t.status]||d.pending,D=t.items.map((n,$)=>{const x=n.discount_percentage!==void 0&&n.discount_percentage>0,k=x?n.price*(1-n.discount_percentage/100):n.price,N=k*n.quantity,V=n.image_url?`<img src="${r(n.image_url)}" alt="${r(n.name)}" width="44" height="44" style="display: block; width: 44px; height: 44px; object-fit: cover; border-radius: 10px; border: 1px solid #e5e7eb;" />`:`<div style="width: 44px; height: 44px; border-radius: 10px; background-color: #f1f5f9; border: 1px solid #e5e7eb; text-align: center; line-height: 44px; color: #94a3b8; font-weight: 800; font-size: 11px;">${$+1}</div>`,C=x?`<span style="text-decoration: line-through; color: #94a3b8; margin-right: 6px; font-size: 11px; font-family: ${e};">${s(n.price)}</span><span style="color: #dc2626; font-weight: 800; font-family: ${e};">${s(k)}</span>`:s(n.price);return`
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
            <tr>
              ...
              <td style="vertical-align: middle;">
                ...
                ${x?`<div style="margin-top: 5px;"><span style="display: inline-block; font-size: 10px; background-color: #fee2e2; color: #b91c1c; padding: 3px 7px; border-radius: 999px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.4px; font-family: ${e};">-${n.discount_percentage}% off</span></div>`:""}
              </td>
            </tr>
          </table>
        </td>
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" style="width: 100%; border-collapse: collapse;">
            <tr>
              ...
              <td style="width: 25%; padding: 0 0 12px 0; vertical-align: top;">
                ...
                <div style="margin-top: 5px;"><span style="display: inline-block; padding: 5px 11px; border-radius: 999px; border: 1px solid; font-size: 10px; font-weight: 900; text-transform: uppercase; letter-spacing: 0.7px; font-family: ${e}; ${F}">${r(t.status)}</span></div>
              </td>
            </tr>
          </table>
        </td>
  ...
  `}function H(t){const o=I(t);return`<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Invoice #${u(t)}</title>
  <style>
...
</html>`}function X(t){const o=u(t),i=H(t),a=new Blob([i],{type:"text/html"}),e=URL.createObjectURL(a),r=document.createElement("a");r.href=e,r.download=`invoice-${o}.html`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(e),h.success("Invoice downloaded!",{duration:2e3})}async function tt(t,o){var p;const i=I(t),a=u(t),e=H(t),s=`data:text/html;base64,${btoa(unescape(encodeURIComponent(e)))}`,f={user_email:o,order_id:a,customer_name:((p=t.user_email)==null?void 0:p.split("@")[0])||"Valued Customer",html:i,invoice_html:i,invoice_file:s};try{const c=await G.send(b.emailjs.serviceId,b.emailjs.templateId,f,b.emailjs.publicKey);console.log("Email sent!",c),h.success(`Invoice sent to ${o}!`,{duration:4e3})}catch(c){console.error("EmailJS error:",c),h.error("Failed to send email. Invoice downloaded instead."),X(t)}}export{X as downloadInvoice,I as generateInvoiceFragment,H as generateInvoiceHTML,tt as sendInvoiceToEmail};
