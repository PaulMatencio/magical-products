                            ...
                            <AnimatePresence mode="wait">
                              {confirmCancelId === order.id ? (
                                <motion.div
                                  ...
                                  className="rounded-2xl border border-rose-100 dark:border-rose-900/60 bg-rose-50 dark:bg-rose-950/30 p-3"
                                >
                                  <div className="flex items-start gap-2 text-rose-700 dark:text-rose-300">
                                    <AlertTriangle className="w-4 h-4 shrink-0 mt-0.5" />
                                    <p className="text-xs font-bold">Cancel this order and return items to inventory?</p>
                                  </div>
                                  <div className="flex gap-2 mt-3">
                                    ...
                                    <button
                                      ...
                                      disabled={isCancelling === order.id}
                                      className="px-3 py-2 text-slate-500 dark:text-slate-300 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all disabled:opacity-50"
                                    >
                                      <X className="w-4 h-4" />
                                    </button>
                                  </div>
                                ...
                                <motion.button
                                  ...
                                  className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-white dark:bg-slate-900 border border-rose-100 dark:border-rose-900/60 text-rose-600 dark:text-rose-300 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-all text-xs font-black uppercase tracking-widest"
                                >
